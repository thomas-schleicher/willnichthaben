...
VALUES
    ...
    (7, 'Luxury City Penthouse', 3, 'Stunning penthouse featuring premium finishes, floor-to-ceiling windows, and a wrap-around terrace',
    ...
    (8, 'Leopoldstadt Modern Apartment', 2, 'Contemporary 3-room apartment with high-quality amenities',
    ...
    (9, 'Central Student Studio', 1, 'Well-designed studio apartment in prime location',
    ...
    (10, 'Döbling Luxury Villa', 4, 'Prestigious villa with panoramic views of Vienna',
    ...
    (11, 'Smart Home Mödling', 5, 'Modern family house with latest technology',
