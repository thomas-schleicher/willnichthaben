...
VALUES
    ...
    (1, 'Luxury City Penthouse', 3, 'Stunning penthouse featuring premium finishes, floor-to-ceiling windows, and a wrap-around terrace',
    ...
    (2, 'Leopoldstadt Modern Apartment', 2, 'Contemporary 3-room apartment with high-quality amenities',
    ...
    (3, 'Central Student Studio', 1, 'Well-designed studio apartment in prime location',
    ...
    (4, 'Döbling Luxury Villa', 4, 'Prestigious villa with panoramic views of Vienna',
    ...
    (5, 'Smart Home Mödling', 5, 'Modern family house with latest technology',
